...
BASE_PATH = "/Users/zxgan/FYP_Kubernetes/Dataset/Feature_Engineered"
    ...
    if os.path.exists(file_path):
        ...
        return pd.DataFrame(
            columns=[
                ...
                "memory_request_utilization_rate",
                "Memory_to_CPU_Ratio",
                "Memory_to_Disk_Ratio",
                "Memory_to_Network_Ratio",
                "Memory_to_Temperature_Ratio",
                "memory_usage_peak",
            ]
        )  # Default columns
...
def app(node):
    st.title("Memory Usage Overview")
